...
const code = fs.readFileSync(deferredPath, 'utf8');
...
const componentsPath = 'components/EVFaq.jsx';
const evFaqCode = `import { useState } from 'react';
...
fs.writeFileSync(componentsPath, evFaqCode);
console.log('Created components/EVFaq.jsx');
