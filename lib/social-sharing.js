...
export const DEFAULT_SOCIAL_IMAGES = {
  // Homepage
  home: '/herobanner/chiangmaiusedcar.webp',

  // Product pages (cars)
  car: '/herobanner/kn2carbanner.webp',

  // All cars listing
  'all-cars': '/herobanner/allusedcars.webp',
  ...
  // Promotion
  promotion: '/herobanner/promotion.webp',

  // Credit check & calculator
  'credit-check': '/herobanner/kn2carbanner2.webp',
  'payment-calculator': '/herobanner/kn2carbanner2.webp',
 ...
 */
export function getSocialImageUrl(pageType = 'default', baseUrl = 'https://chiangmaiusedcar.com') {
 ...
 */
export function getPlatformImage(pageType, platform = 'og_primary') {
  const baseUrl = getSocialImageUrl(pageType);
