...
/**
 * สร้าง ImageObject JSON-LD Schema สำหรับรูปภาพรถยนต์
 * เพื่อปรับปรุง SEO และการแสดงผลรูปภาพใน Google Search
 * @param {Object} opts - ตัวเลือกการตั้งค่า
 * @returns {Object} ImageObject JSON-LD schema
 */
export function buildImageObjectJsonLd(opts) {
  ...
  return {
    ...
    copyrightNotice: `© ${new Date().getFullYear()} ครูหนึ่งรถสวย สงวนสิทธิ์ทุกประการ`,
    copyrightHolder: {
      '@type': 'Organization',
      name: 'ครูหนึ่งรถสวย',
      url: site,
    ...
    usageInfo: `${site}/terms-of-service`,
    ...
    associatedArticle: {
      '@type': 'Product',
      name: `${carBrand} ${carTitle} ${carYear}`,
