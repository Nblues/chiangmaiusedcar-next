...
export function buildLocalBusinessJsonLd() {
  return {
    ...
    name: 'ครูหนึ่งรถสวย',
    alternateName: 'Khru Neung Rod Suay Used Cars Chiangmai',
    description:
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://www.chiangmaiusedcar.com/logo/logo_main.png',
      width: 250,
      height: 60,
    },
    image: 'https://www.chiangmaiusedcar.com/logo/logo_main.png',
    telephone: '+66940649018',
