...
เว็บไซต์ **ครูหนึ่งรถสวย** ผ่านเกณฑ์ Google Search Essentials **95%** มีการปรับปรุงเล็กน้อยที่แนะนำเพื่อเพิ่มประสิทธิภาพ
SEO
...
- ✅ **Next.js Image Optimization**:
  ...
  ```jsx
  <Image src="/herobanner/cnxcar.webp" alt="รถมือสองเชียงใหม่" width={1920} height={640} priority />
  ```
...
- ⚡ **Preload critical fonts**:
  ...
  ```jsx
  <link rel="preload" href="/fonts/prompt-regular.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />
  ```
...
- 🔍 **Global Search** (ใน navbar):
  ...
  <form action="/all-cars" method="GET">
    <input type="search" name="search" placeholder="ค้นหารถ (เช่น Honda City)" aria-label="ค้นหารถยนต์" />
  </form>
  ```
...
- 📊 **Comparison Table**: | Feature | Car 1 | Car 2 | Car 3 | |---------|-------|-------|-------| | ราคา | 329k | 399k
  | 289k | | ปี | 2020 | 2021 | 2019 | | ไมล์ | 45k | 30k | 60k |
...
- 📞 **Sticky WhatsApp/LINE Button**:
  ...
  ```jsx
  <a href="https://lin.ee/8ugfzstD" className="fixed bottom-4 right-4 z-50">
    <LineIcon /> สอบถามเลย
  </a>
  ```
