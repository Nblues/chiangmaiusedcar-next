    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 font-prompt antialiased text-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 mb-8 transform transition-all duration-300">
             <ToolsPanel />
          </div>
        </div>
      </div>
...
AdminDashboard.getLayout = function getLayout(page) {
  return (
    <main id="main" role="main" className="antialiased">
      {page}
    </main>
  );
};
...
fs.writeFileSync('pages/admin/dashboard.jsx', content);
