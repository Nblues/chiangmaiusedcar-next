            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-xl bg-orange-700 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-800 active:scale-95 active:bg-orange-900 transition-all duration-200"
                >
                  ฝากขายราคาดี
                </Link>
                <Link
                  href="/ev-cars-chiang-mai"
                  className="inline-flex items-center justify-center rounded-xl bg-green-700 px-4 py-2 text-sm font-semibold text-white hover:bg-green-800 active:scale-95 transition-all duration-200"
                >
                  ⚡ รถ EV มือสอง
                </Link>
                <Link
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-orange-400 bg-white px-3 py-1.5 text-xs font-semibold text-gray-800 hover:bg-orange-50 hover:border-orange-600 active:scale-95 active:bg-orange-100 transition-all duration-200"
                  >
                    {item.label}
                  </Link>
                ))}
