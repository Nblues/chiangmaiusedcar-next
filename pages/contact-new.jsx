  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'เปิดทุกวัน 9:00 - 18:00 น. วันหยุดราชการปกติ',
        },
      },
      {
        '@type': 'Question',
        ...
        <div className="bg-gradient-to-br from-primary to-primary-600 text-white py-16">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-white/20 px-4 py-2 rounded-full">⏰ เปิดทุกวัน 9:00-18:00</span>
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-gold/10 p-4 rounded-lg md:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-700">จันทร์ - อาทิตย์ เวลา 9:00 - 18:00 น.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-md group">
                ...
                <div className="pt-4 text-gray-700">
                  A: เปิดทุกวัน 9:00 - 18:00 น. วันหยุดราชการปกติ
                </div>
              </details>
              <details className="bg-white p-6 rounded-lg shadow-md group">
                <summary className="font-semibold text-primary cursor-pointer flex justify-between items-center">
