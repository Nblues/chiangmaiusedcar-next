...
export default function BlogImages() {
  ...
  return (
    <div>
      <SEO
        title="รูปภาพบล็อกและรีวิว - ครูหนึ่งรถสวย"
        description="รวมรูปภาพจากบล็อกและรีวิวของลูกค้า ครูหนึ่งรถสวย รถมือสองเชียงใหม่"
        keywords="รูปภาพบล็อก, รีวิวลูกค้า, รถมือสองเชียงใหม่, ครูหนึ่งรถสวย"
      ...
      <section className="bg-gradient-to-r from-primary to-primary-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-prompt">รูปภาพบล็อกและรีวิว</h1>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 font-prompt">
                    รูปภาพจากบล็อกและเนื้อหาของ ครูหนึ่งรถสวย
                  </p>
                </div>
              </div>
            ))}
