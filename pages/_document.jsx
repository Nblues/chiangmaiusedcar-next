...
export default class MyDocument extends Document {
  ...
  render() {
    // Cache busting timestamp (used in meta tags only — NOT for static asset URLs)
    const buildTime = process.env.CUSTOM_BUILD_TIME || new Date().toISOString();
    // Stable version for favicon/manifest URLs — changes per deployment, not per request
    const faviconVersion = process.env.VERCEL_DEPLOYMENT_ID || process.env.CUSTOM_BUILD_TIME || '1';
      ...
      <Html lang={htmlLang}>
        <Head>
          ...
          <link
            ...
            type="image/png"
            sizes="48x48"
            href={`/favicon-48.png?v=${faviconVersion}`}
          />
          <link
            rel="icon"
            type="image/png"
            sizes="96x96"
            href={`/favicon-96.png?v=${faviconVersion}`}
          />
          <link
            rel="icon"
            type="image/png"
            sizes="192x192"
            href={`/android-chrome-192x192.png?v=${faviconVersion}`}
          />
          <link
            rel="icon"
            type="image/png"
            sizes="512x512"
            href={`/android-chrome-512x512.png?v=${faviconVersion}`}
          />
          ...
          <link rel="mask-icon" href={`/favicon.svg?v=${faviconVersion}`} color="#1a237e" />

          {/* Microsoft Tiles - Windows Start Menu */}
          <meta
            name="msapplication-TileImage"
            content={`/mstile-150x150.png?v=${faviconVersion}`}
          />
          ...
          <meta
            ...
            content={`/mstile-70x70.png?v=${faviconVersion}`}
          />
          <meta
          ...
          <meta
            ...
            content={`/mstile-310x150.png?v=${faviconVersion}`}
          />
          <meta
            name="msapplication-square310x310logo"
            content={`/mstile-310x310.png?v=${faviconVersion}`}
          />
        ...
        <body>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }} aria-hidden="true">
            <defs>
              ...
              {/* HomeWhyChooseSection Brand Icons */}
              <symbol id="icon-brand-toyota" viewBox="0 0 24 24">
              ...
              <symbol id="icon-brand-honda" viewBox="0 0 24 24">
              ...
              <symbol id="icon-brand-isuzu" viewBox="0 0 24 24">
                <path d="M5.5 3h4.4L8.4 21H4z M14.1 3h4.4l-1.5 18h-4.4z" />
              </symbol>
              <symbol id="icon-brand-mazda" viewBox="0 0 24 24">
              ...
              <symbol id="icon-brand-nissan" viewBox="0 0 24 24">
              ...
              <symbol id="icon-brand-mitsubishi" viewBox="0 0 24 24">
                <path d="M8 22.38H0l4-6.92h8zm8 0h8l-4-6.92h-8zm0-13.84l-4-6.92-4 6.92 4 6.92Z" />
              </symbol>
              <symbol id="icon-brand-ford" viewBox="0 0 24 24">
              ...
              <symbol id="icon-brand-hyundai" viewBox="0 0 24 24">
