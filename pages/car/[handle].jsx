...
function CarDetailPage({ car, recommendedCars = [] }) {
  ...
  const enhancedTitle = `${brandModel} ${yearText} รถบ้านมือสองเชียงใหม่ ฟรีดาวน์ | ครูหนึ่งรถสวย`
    .replace(/\s+/g, ' ')
    .trim();
        ...
        <div className="max-w-6xl mx-auto p-2 sm:p-4 lg:p-6">
              ...
              >
                ...
                <div className="flex items-center gap-2 lg:gap-2.5 whitespace-nowrap">
                  <div className="flex gap-1">
                    <kbd className="bg-white/25 px-2 py-1 rounded-md text-[13px] font-sans font-medium shadow-sm border border-white/20">
                      ←
                    </kbd>
                    <kbd className="bg-white/25 px-2 py-1 rounded-md text-[13px] font-sans font-medium shadow-sm border border-white/20">
                      →
                  ...
                  <span className="ml-0.5 font-medium tracking-wide text-sm font-prompt text-white shadow-sm">
                    เลื่อนรูปภาพ
                  </span>
                </div>
              </div>
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#bf360c] hover:bg-[#992b0a] text-white flex items-center gap-2 px-4 py-3 rounded-lg font-prompt transition-colors"
                ...
                {[
                  ...
                  .map((spec, i) => (
                    <div key={i} className="flex flex-col py-1">
                      ...
                      <span
                        className="text-base font-semibold text-gray-900 font-prompt truncate"
                          ...
                          {processedDescription.paragraphs.map((paragraph, index) => {
                            ...
                            if (keywords.test(pText)) {
                              ...
                              return (
                                ...
                                >
                                  {parts.map((part, i) =>
                                    /(รถบ้าน|มือเดียว|ไม่เคยชน|รับประกัน|ไมล์แท้|สภาพนางฟ้า|พร้อมใช้งาน|ขับดี|แอร์เย็น)/.test(
                                      part
                                    ) ? (
                                      <strong
                                        key={i}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Line: @krunuengusedcar"
                >
          ...
          <div className="bg-slate-50/50 rounded-2xl border border-gray-100 p-4 sm:p-6 mb-6">
            <div className="flex items-center gap-2.5 mb-4 sm:mb-5">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 font-prompt m-0">
                ขั้นตอนการซื้อรถ
              </h2>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-300 rounded-xl p-3 flex flex-col relative overflow-hidden group"
                >
                  ...
                  <p className="text-[11px] sm:text-sm text-gray-500 font-prompt leading-snug">
                    {item.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pb-24 sm:pb-8 mt-6 px-4">
            ...
            >
              <svg
                className="w-5 h-5 mr-3 text-gray-500 group-hover:-translate-x-1 transition-transform duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <svg
                className="w-5 h-5 ml-3 text-white/80 group-hover:translate-x-1 transition-transform duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
