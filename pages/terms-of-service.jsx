            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  ครูหนึ่งรถสวย ให้บริการดังต่อไปนี้:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  ข้อมูลรถยนต์และราคาที่แสดงบนเว็บไซต์:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                ...
                <div className="bg-blue-50 p-4 rounded-lg mb-4">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                    ...
                    <li>ต้องมาชำระเงินมัดจำภายใน 24 ชั่วโมง</li>
                ...
                <div className="bg-green-50 p-4 rounded-lg mb-4">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                    ...
                    <li>มีการรับประกันเครื่องยนต์และเกียร์ 3 เดือน (ตามเงื่อนไข)</li>
              ...
              <section className="mb-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2 text-sm">
                    <li><strong>เครื่องยนต์:</strong> ระบบหล่อลื่น การจุดระเบิด (3 เดือน)</li>
                    <li><strong>เกียร์:</strong> ระบบเกียร์อัตโนมัติ/ธรรมดา (3 เดือน)</li>
                    <li><strong>ไม่รับประกัน:</strong> ชิ้นส่วนที่สึกหรอตามปกติ เช่น ยาง แบตเตอรี่ ฟิลม์กรอง</li>
                    <li><strong>เงื่อนไข:</strong> ต้องเข้าเช็คระบบตามกำหนด</li>
                  </ul>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">8. ข้อจำกัดความรับผิดชอบ</h2>
                <p className="text-gray-700 mb-4">
                  ครูหนึ่งรถสวย จะไม่รับผิดชอบต่อ:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  เนื้อหาทั้งหมดในเว็บไซต์ เช่น ข้อความ รูปภาพ โลโก้ วิดีโอ เป็นทรัพย์สินทางปัญญาของ ครูหนึ่งรถสวย 
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700">
                  ข้อกำหนดนี้อยู่ภายใต้กฎหมายไทย หากเกิดข้อพิพาท ให้อยู่ในเขตอำนาจศาลจังหวัดเชียงใหม่
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700"><strong>เวลาทำการ:</strong> จันทร์-อาทิตย์ 8:00-18:00 น.</p>
                </div>
              </section>
