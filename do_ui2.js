...
let newHTML = \<div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 font-thai antialiased selection:bg-accent selection:text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 min-h-[600px]">
          ...
          <div className="lg:col-span-4 h-full">
            <Card className="h-full shadow-2xl shadow-indigo-50/50 border border-slate-200/60 rounded-[2rem] bg-white/95 backdrop-blur-2xl overflow-hidden flex flex-col">
              \
c=c.replace(/<div className="min-h-screen bg-\[\#f8f9fa\] p-4 sm:p-6 lg:p-8 font-thai">[\s\S]*?(?=<div className="h-2 w-full bg-gradient-to-r)/, newHTML);
