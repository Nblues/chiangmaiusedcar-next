...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-gray-900 text-white pt-12 pb-24 md:py-12 mt-16 font-prompt min-h-[600px] sm:min-h-[400px] "
      role="contentinfo"
    >
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-success-500 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-brand-500 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path
                      fillRule="evenodd"
          ...
          {/* Mobile Wrapper for Socials & Maps */}
          <div className="col-span-1 md:col-span-2 lg:col-span-2 grid grid-cols-2 gap-4 lg:gap-12">
            {/* Social Media */}
            <div className="col-span-1">
              ...
              <div className="space-y-4 mb-6">
                <a
                  ...
                  target="_blank"
                  className="flex items-center space-x-2 lg:space-x-3 p-2 lg:p-3 rounded-lg hover:bg-gray-800 transition-all duration-300 group w-full overflow-hidden"
                  rel="noopener noreferrer"
                >
                  <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-blue-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform active:scale-[0.97] active:opacity-[0.85]">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-white text-sm lg:text-base font-medium group-hover:text-blue-400 transition-colors truncate">
                      Facebook
                    </p>
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ครูหนึ่งรถสวย</p>
                  </div>
                </a>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-green-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform active:scale-[0.97] active:opacity-[0.85]">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-white text-sm lg:text-base font-medium group-hover:text-green-400 transition-colors truncate">
                      LINE
                    </p>
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ครูหนึ่งรถสวย</p>
                  </div>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-red-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform active:scale-[0.97] active:opacity-[0.85]">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-white text-sm lg:text-base font-medium group-hover:text-red-400 transition-colors truncate">
                      YouTube
                    </p>
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ครูหนึ่งรถสวย</p>
                  </div>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-gray-800 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform active:scale-[0.97] active:opacity-[0.85]">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-white text-sm lg:text-base font-medium group-hover:text-pink-400 transition-colors truncate">
                      TikTok
                    </p>
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ครูหนึ่งรถสวย</p>
                  </div>
              ...
              <a
                href="https://lin.ee/8ugfzstD"
                target="_blank"
                className="block w-full bg-primary hover:bg-primary-600 text-white text-center py-3 px-4 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 active:scale-[0.97] active:opacity-[0.85]"
                rel="noopener noreferrer"
              >
                สอบถามเลย
              </a>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ดูตำแหน่งร้าน</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 truncate">รีวิวลูกค้า</p>
                  </div>
                </a>
                ...
                <Link
                  ...
                  className="flex items-center space-x-2 lg:space-x-3 p-2 lg:p-3 rounded-lg hover:bg-gray-800 transition-all duration-300 group w-full overflow-hidden"
                >
                  <div className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 bg-green-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform active:scale-[0.97] active:opacity-[0.85]">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 truncate">ดูทางเดินทาง</p>
                  </div>
                </Link>
              </div>
            </div>
