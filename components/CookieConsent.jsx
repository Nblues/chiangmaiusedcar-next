...
const CookieConsent = () => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-2xl z-50 font-prompt transform transition-transform duration-500 ease-in-out ${
