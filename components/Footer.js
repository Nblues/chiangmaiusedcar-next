...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-brand-950 to-gray-900 text-white">
      {/* Main Footer Content */}
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              <div className="relative">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-accent-400 to-accent-600 p-0.5 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-white font-medium">ที่อยู่ร้าน</p>
                  <p className="text-gray-300 text-sm">
                    เลขที่ 320 หมู่ 2 ถนน สมโภชเชียงใหม่ 700 ปี
                    <br />
          ...
          <div>
            ...
            <a
              href="https://lin.ee/cJuakxZ"
              target="_blank"
              className="block w-full bg-gradient-to-r from-success-500 to-success-600 hover:from-success-600 hover:to-success-700 text-white text-center py-3 px-4 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              สอบถามเลย
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.0123456789!2d99.0144444!3d18.7986111!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30da39b7b3b3b3b3%3A0x1234567890abcdef!2z4LiE4Lij4Li54Lir4LiZ4Li24LmI4LiH4Lij4LiW4LmA4Li04LiB!5e0!3m2!1sth!2sth!4v1234567890123!5m2!1sth!2sth"
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowFullScreen
