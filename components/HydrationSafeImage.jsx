...
function generateAltText(src, context = '', carData = null) {
  ...
  if (!src || typeof src !== 'string') {
    return context || 'รถมือสอง เชียงใหม่';
  }
 ...
 * Fixed version that prevents hydration mismatches by ensuring consistent server/client rendering
 */
export default function HydrationSafeImage({
  ...
  // State for client-side rendering to prevent hydration mismatch
