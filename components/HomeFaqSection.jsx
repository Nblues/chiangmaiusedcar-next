...
export default function HomeFaqSection() {
  return (
    ...
    <section className="mb-8 sm:mb-12 max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10" aria-labelledby="trust-features-heading">
...
<section className="bg-white py-8 sm:py-10 mt-6 rounded-3xl max-w-6xl mx-auto border border-gray-200 shadow-sm cv-auto">
      <div className="px-4 sm:px-6">
        <div className="mb-5 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-primary font-prompt">คำถามที่พบบ่อย</h2>
    ...
    <section className="mt-8 mb-4 sm:mb-8 max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10" aria-label="ช่องทางลัดบริการ">
