        ...
        <div className="relative rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 border border-white/60 shadow-lg bg-gradient-to-br from-white via-gray-50/80 to-white/90 backdrop-blur-xl mb-2 sm:mb-4">
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8 md:text-left">
            <div>
              ...
              <p className="text-gray-600 font-prompt text-sm sm:text-base leading-relaxed">
          ...
          <div className="relative z-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 pb-2">
            ...
            {/* View All button on mobile to replace the hidden top link */}
            <Link
              href="/all-cars"
              prefetch={false}
              className="md:hidden col-span-2 sm:col-span-3 flex items-center justify-center px-6 py-4 mt-2 bg-gray-900 text-white rounded-full font-bold text-base sm:text-lg font-prompt active:scale-95 transition-transform shadow-md"
            >
              ดูรถทุกยี่ห้อ (ดูทั้งหมด) ➔
            </Link>
          </div>
        </div>
      </div>
