...
const searchString = 'next/document';
    ...
    for (const file of files) {
        ...
        if (stat.isDirectory()) {
            ...
            if (content.includes(searchString) && fullPath !== path.normalize('pages/_document.jsx')) {
                console.log(`Found suspicious import in: ${fullPath}`);
...
console.log('Searching for "next/document" imports outside of _document.jsx...');
